...
appearance_D = import_pickle(f"{DEEZER_processed_path}D_appearance.pkl")
disappearance_D = import_pickle(f"{DEEZER_processed_path}D_disappearance.pkl")
...
compute_embeddings(
    ...
    f"{DEEZER_processed_path}appearance_embeddings_train.csv",
)
compute_embeddings(
    disappearance_D,
    users_tag_ranking,
    train_disappearance_trajectories,
    f"{DEEZER_processed_path}disappearance_embeddings_train.csv",
)
compute_embeddings(
    appearance_D,
    users_tag_ranking,
    test_appearance_trajectories,
    f"{DEEZER_processed_path}appearance_embeddings_test.csv",
)
compute_embeddings(
    disappearance_D,
    users_tag_ranking,
    test_disappearance_trajectories,
    f"{DEEZER_processed_path}disappearance_embeddings_test.csv",
)
